const ServiceCard = ({ icon, title, description, delay = 0, isVisible = true }) => {
  return (
    <div
    ...
    >
      ...
      <div className="relative flex flex-col items-center text-center gap-4 p-6 h-full justify-between">
        {/* Icon */}
        ...
        <div className="space-y-2 flex-1">
          <h3 className="text-lg font-bold text-white group-hover:text-violet-200 transition-colors">{title}</h3>
